          ...
          <article className="postcard light blue">
            ...
            <div className="postcard__text t-dark">
              ...
              <div className="postcard__preview-txt">
                ...
                treatment, and prevention of heart-related conditions. Our team
                of experienced cardiologists and state-of-the-art facilities
                ensure comprehensive cardiac care, including advanced diagnostic
                tests, interventional procedures, and personalized treatment
                plans.
              </div>
          ...
          <article className="postcard light blue">
            ...
            <div className="postcard__text t-dark">
              ...
              <div className="postcard__preview-txt">
                ...
                conditions. With a team of skilled orthopedic surgeons, physical
                therapists, and rehabilitation specialists, we aim to restore
                mobility, reduce pain, and enhance the quality of life for our
                patients.
              </div>
              <ul className="postcard__tagbox">
                <li className="tag__item">
          ...
          <article className="postcard light blue">
            ...
            <div className="postcard__text t-dark">
              ...
              <div className="postcard__preview-txt">
                ...
                providing exceptional cancer care. Our multidisciplinary team of
                oncologists, surgeons, and support staff works collaboratively
                to offer the latest in cancer treatment options, including
                chemotherapy, radiation therapy, immunotherapy, and targeted
                therapies, with a focus on personalized care and improved
                patient outcomes.
              </div>
              <ul className="postcard__tagbox">
                <li className="tag__item">
